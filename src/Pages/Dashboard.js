...
const dummyLeads = [
  ...
  try {
    setLoading(true)
    const response = await axios.get("https://assignmentbackend-r1xe.onrender.com/api/v1/admin/logoutuser",{withCredentials:true})
  ...
  useEffect(()=>{
    (async()=>{
      const response = await axios.get("https://assignmentbackend-r1xe.onrender.com/api/v1/admin/getuser",{withCredentials:true})
  ...
  useEffect(()=>{
    (async()=>{
      const response = await axios.get("https://assignmentbackend-r1xe.onrender.com/api/v1/admin/getalluser",{withCredentials:true})
      console.log(response.data.data)
